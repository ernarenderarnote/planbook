<div class="modal-dialog">
    ...
    <div class="modal-content">
       <form method="post" action="#" id="assignment_edit_form" class="editlessonform addassignmentform class-form">
        {{ csrf_field() }}
        <input type="hidden" id="assignment_id" name="unit_id" value="{{ $assignment->id }}"/>
          <div class="modal-header">
             ...
             <div class="actionright pull-right">
                <button type="button" id="save_edit_assignment_data_button" class="actiondropbutton renew-button">Save</button>
          ...
          <div class="modal-body">
             <div class="row">
                <div class="col-md-4 form-group">
                   ...
                   <select id="class" name="class" class="form-control">
                      ...
                      @if($userClass->id == $assignment->class_id)  selected="selected"; @endif >{{$userClass->class_name}}</option>
             ...
             <div class="row">
                <div class="col-md-4 form-group">
                   <label>Type</label>
                   <select id="assignmentType" class=" input-fields" >
                      <option value="0">Select Type</option>
                   </select>
                </div>
                <div class="col-md-4 form-group">
                   <label>Total Points</label>
                   <input id="total_points" name="total_points" class=" input-fields" value="{{ $assignment->total_points }}" type="text">
                </div>
             </div>
             <div class="row">
                <div class="form-group col-md-12 titlefield">
                   <label> Title</label>
                   <input type="text" id="title" name="title" value="{{ $assignment->title }}" class="memorialtitlefied">
                </div>
             </div>
             <div class="Description-memorial ">
                <p>Description</p>
                <textarea class="editorMce" name="description" placeholder="Write Somehting">{{ $assignment->description }}</textarea>
             </div>
