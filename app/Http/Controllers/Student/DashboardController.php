...
class DashboardController extends Controller
{
   ...
   /**
    ...
    public function weekView()
    {
        ...
        return view('student.dashboard.weekCalendar', $this->data);

    }
    public function dayView()
    {

        return view('student.dashboard.dayCalendar', $this->data);
	...
	public function showCalendar(Request $request){
        ...
        return view('student.dashboard.showCalendar', $this->data);
